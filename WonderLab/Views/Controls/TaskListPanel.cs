...
public sealed class TaskListPanel : TemplatedControl {
    ...
    protected override void OnLoaded(RoutedEventArgs e) {
        ...
        _contentLayout.RenderTransform = TransformOperations.Parse($"translateX({_contentLayout.Bounds.Width + 15}px)");
    ...
    protected override void OnPropertyChanged(AvaloniaPropertyChangedEventArgs change) {
        ...
        if (change.Property == IsPaneOpenProperty) {
            var px = change.GetNewValue<bool>() ? 0 : _contentLayout.Bounds.Width + 15;
